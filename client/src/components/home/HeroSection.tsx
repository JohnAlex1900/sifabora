      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col md:flex-row items-center">
          <div className="w-full md:w-1/2 text-white mb-8 md:mb-0">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link
                href="/contact"
                className="bg-white text-primary font-medium px-8 py-3 rounded-md hover:bg-opacity-90 transition-all duration-300 text-center shadow-lg"
              >
                Request Help
              </Link>
              <Link
                href="/services"
                className="bg-transparent border-2 border-white text-white font-medium px-8 py-3 rounded-md hover:bg-white hover:bg-opacity-10 transition-all duration-300 text-center"
              >
                Explore Services
              </Link>
            </div>
          ...
          {/* Professional working at a desk with digital security elements */}
        ...
        <div className="mt-16 pt-8 border-t border-white border-opacity-20">
          ...
          <div className="flex flex-wrap justify-center gap-8 md:gap-16">
            <div className="text-white opacity-80 font-bold text-center">
