        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            <Link href="/" className="inline-block mb-6">
              <span className="text-white font-bold text-2xl">Sifabora</span>
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                <i className="fas fa-phone-alt mt-1 mr-3 text-white text-opacity-80"></i>
              ...
              <li className="flex items-start">
                <i className="fas fa-envelope mt-1 mr-3 text-white text-opacity-80"></i>
                <span className="text-white text-opacity-80">
                  info@sifabora.africa
                </span>
              </li>
              <li className="flex items-start">
                <i className="fas fa-clock mt-1 mr-3 text-white text-opacity-80"></i>
